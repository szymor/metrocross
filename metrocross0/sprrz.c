...
void SprRotoZoom_Render(void)
{
	static s32	pLnBufL[ROT2D_BUF_Height];	// Buffer de lignes.
	static s32	pLnBufR[ROT2D_BUF_Height];	// On remplira en x de L à R sur chaque ligne raster.
	static s32	pMapXBufL[ROT2D_BUF_Height];	// Idem avec les coordonnées de mapping.
	static s32	pMapYBufL[ROT2D_BUF_Height];
	static s32	pMapXBufR[ROT2D_BUF_Height];
	static s32	pMapYBufR[ROT2D_BUF_Height];
	u32	i;
