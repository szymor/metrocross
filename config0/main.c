...
#define PROJECT_NAME	"Metro-Cross"
#define	WINDOW_CAPTION	"Metro-Cross CFG"
...
//		"Button B (Get/Drop)",
		...
		"Joystick Button A (Jump)",
//		"Joystick Button B (Get/Drop)",
...
//				gMSCfg.pKeys[e_CfgKey_JoyButtonA] = gMSCfg.pKeys[e_CfgKey_JoyButtonB] = 0xFFFF;
				gMSCfg.pKeys[e_CfgKey_JoyButtonA] = 0xFFFF;
				break;
